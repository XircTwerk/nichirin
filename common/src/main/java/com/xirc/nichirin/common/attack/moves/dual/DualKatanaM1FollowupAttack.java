...
/** Mirrored offhand cut that closes the alternating light combo. */
public final class DualKatanaM1FollowupAttack extends DualKatanaAttackBase {
    private boolean executed;

    @Override
    protected void onStart() {
        executed = false;
        playSwingSound(1.12f);
    }
