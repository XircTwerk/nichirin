...
public class BlockingInputHandler {
    ...
    private static boolean canBlock(Player player) {
        // The ChainBallAxe ball-and-chain can't guard (for now) — RMB is its attack, not a block.
        if (com.xirc.nichirin.client.chainballaxe.ClientChainBallAxeWeaponManager.isEnabled()) return false;
