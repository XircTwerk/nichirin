...
public class SimpleSlashAttack {
    ...
    public SimpleSlashAttack(int startup, int active, int recovery, float damage, float range,
    ...
    public static class Builder {
        ...
        public SimpleSlashAttack build() {
            return new SimpleSlashAttack(startup, active, recovery, damage, range, knockback,
