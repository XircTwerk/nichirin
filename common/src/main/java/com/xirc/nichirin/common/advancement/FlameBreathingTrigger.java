...
/**
 * Custom trigger for unlocking Flame Breathing
 */
public class FlameBreathingTrigger extends SimpleCriterionTrigger<FlameBreathingTrigger.TriggerInstance> {

    public static final FlameBreathingTrigger INSTANCE = new FlameBreathingTrigger();
    private static final ResourceLocation ID = BreathOfNichirin.id("flame_breathing_unlock");
