...
public final class NichirinPerkRegistry {
    ...
    static {
        ...
        register(PerkDefinition.builder("killer_instinct", "Killer Instinct")
                .description("Deal more damage to enemies under 35% health.")
                ...
                .tierDesc(PerkTier.UNCOMMON,  "Deal +7% damage to enemies below 35% HP.")
                .tierDesc(PerkTier.RARE,      "Deal +12% damage to enemies below 35% HP.")
                .tierDesc(PerkTier.EPIC,      "Deal +18% damage to enemies below 35% HP.")
                .tierDesc(PerkTier.LEGENDARY, "Deal +25% damage to enemies below 35% HP.")
