...
public final class NichirinPerkRegistry {
    ...
    static {
        ...
        register(PerkDefinition.builder("breath_efficiency", "Breath Efficiency")
                ...
                .tierDesc(PerkTier.COMMON,    "Breathing techniques cost 8% less.")
                .tierDesc(PerkTier.UNCOMMON,  "Breathing techniques cost 15% less.")
                .tierDesc(PerkTier.RARE,      "Breathing techniques cost 25% less.")
                .tierDesc(PerkTier.EPIC,      "Breathing techniques cost 38% less.")
                .tierDesc(PerkTier.LEGENDARY, "Breathing techniques cost 50% less. Passively recover 0.5 breath per second.")
        ...
        register(PerkDefinition.builder("breath_recovery", "Breath Recovery")
                ...
                .tierDesc(PerkTier.COMMON,    "Idle breath recovery is 15% faster.")
                .tierDesc(PerkTier.UNCOMMON,  "Idle breath recovery is 28% faster.")
                .tierDesc(PerkTier.RARE,      "Idle breath recovery is 45% faster. Slow walking counts as idle.")
                .tierDesc(PerkTier.EPIC,      "Idle breath recovery is 65% faster. Walking counts as idle.")
                .tierDesc(PerkTier.LEGENDARY, "Idle breath recovery is 85% faster. Sprinting no longer pauses recovery.")
        ...
        register(PerkDefinition.builder("breath_focus", "Breath Focus")
                ...
                .tierDesc(PerkTier.EPIC,      "Breath hits stun enemies for 0.6s longer. Finisher stuns have +40% duration.")
                .tierDesc(PerkTier.LEGENDARY, "Breath hits stun for 0.8s longer. Finishers briefly root enemies in place.")
        ...
        register(PerkDefinition.builder("flow_state", "Flow State")
                ...
                .tierDesc(PerkTier.RARE,      "5 consecutive breath hits: +12% damage for 10s.")
                .tierDesc(PerkTier.EPIC,      "5 consecutive breath hits: +20% damage for 10s. Missing resets only 2 stacks.")
                .tierDesc(PerkTier.LEGENDARY, "5 consecutive breath hits: +28% damage for 10s. Missing resets 0 stacks for 3 seconds.")
        ...
        register(PerkDefinition.builder("zen_mastery", "Zen Mastery")
                ...
                .tierDesc(PerkTier.EPIC,      "Below 50% HP: breathing costs 25% less.")
                .tierDesc(PerkTier.LEGENDARY, "Below 50% HP: breathing costs 45% less and recovers 30% faster.")
        ...
        register(PerkDefinition.builder("breath_overflow", "Breath Overflow")
                ...
                .tierDesc(PerkTier.EPIC,      "10% chance per breath technique use to consume no breathing.")
                .tierDesc(PerkTier.LEGENDARY, "18% chance per breath technique use to consume no breathing. Proc also regens 8% breath.")
        ...
        register(PerkDefinition.builder("iron_will", "Iron Will")
                .description("Take reduced damage when below 35% HP.")
                ...
                .tierDesc(PerkTier.COMMON,    "Below 35% HP: take 8% less damage.")
                .tierDesc(PerkTier.UNCOMMON,  "Below 35% HP: take 15% less damage.")
                .tierDesc(PerkTier.RARE,      "Below 35% HP: take 24% less damage.")
                .tierDesc(PerkTier.EPIC,      "Below 35% HP: take 35% less damage.")
                .tierDesc(PerkTier.LEGENDARY, "Below 35% HP: take 48% less damage. Brief speed boost on proc.")
        ...
        register(PerkDefinition.builder("killer_instinct", "Killer Instinct")
                ...
                .tierDesc(PerkTier.UNCOMMON,  "Deal +10% damage to enemies below 40% HP.")
                .tierDesc(PerkTier.RARE,      "Deal +18% damage to enemies below 40% HP.")
                .tierDesc(PerkTier.EPIC,      "Deal +28% damage to enemies below 40% HP.")
                .tierDesc(PerkTier.LEGENDARY, "Deal +40% damage to enemies below 40% HP.")
        ...
        register(PerkDefinition.builder("relentless_assault", "Relentless Assault")
                ...
                .tierDesc(PerkTier.UNCOMMON,  "3 consecutive hits: no attack windup for 4s.")
                .tierDesc(PerkTier.RARE,      "3 consecutive hits: no attack windup for 6s.")
                .tierDesc(PerkTier.EPIC,      "3 consecutive hits: no attack windup for 8s. Missing resets to 2 hits instead of 0.")
                .tierDesc(PerkTier.LEGENDARY, "3 consecutive hits: no attack windup for 11s. Missing never fully resets the counter.")
        ...
        register(PerkDefinition.builder("bloodthirst", "Bloodthirst")
                ...
                .tierDesc(PerkTier.EPIC,      "On kill: Regen II for 4 seconds.")
                .tierDesc(PerkTier.LEGENDARY, "On kill: Regen II for 5 seconds. Killing blow instantly restores 2 HP.")
        ...
        register(PerkDefinition.builder("glass_cannon", "Glass Cannon")
                ...
                .tierDesc(PerkTier.RARE,      "+18% damage dealt. +18% damage taken.")
                .tierDesc(PerkTier.EPIC,      "+28% damage dealt. +22% damage taken.")
                .tierDesc(PerkTier.LEGENDARY, "+40% damage dealt. +28% damage taken.")
        ...
        register(PerkDefinition.builder("juggernaut", "Juggernaut")
                ...
                .tierDesc(PerkTier.RARE,      "-12% movement speed. +15% damage resistance.")
                .tierDesc(PerkTier.EPIC,      "-8% movement speed. +25% damage resistance.")
                .tierDesc(PerkTier.LEGENDARY, "-4% movement speed. +35% damage resistance. Knockback resistance +50%.")
        ...
        register(PerkDefinition.builder("blade_dancer", "Blade Dancer")
                ...
                .tierDesc(PerkTier.RARE,      "-10% damage per hit. Zero attack windup.")
                .tierDesc(PerkTier.EPIC,      "-6% damage per hit. Zero attack windup. Faster combo window.")
                .tierDesc(PerkTier.LEGENDARY, "-3% damage per hit. Zero attack windup. Combo resets give a brief +10% damage bonus.")
        ...
        register(PerkDefinition.builder("adrenaline_rush", "Adrenaline Rush")
                ...
                .tierDesc(PerkTier.UNCOMMON,  "For every 10% HP missing, deal +1.5% more damage. (max +13.5% at 10% HP)")
                .tierDesc(PerkTier.RARE,      "For every 10% HP missing, deal +2.5% more damage. (max +22.5% at 10% HP)")
                .tierDesc(PerkTier.EPIC,      "For every 10% HP missing, deal +3.5% more damage. (max +31.5% at 10% HP)")
                .tierDesc(PerkTier.LEGENDARY, "For every 10% HP missing, deal +4% more damage. (max +36% at 10% HP)")
        ...
        register(PerkDefinition.builder("ghost_step", "Ghost Step")
                ...
                .tierDesc(PerkTier.LEGENDARY, "Dodge i-frames +10 ticks. Leaving i-frames briefly boosts attack speed.")
        ...
        register(PerkDefinition.builder("enduring_spirit", "Enduring Spirit")
                ...
                .tierDesc(PerkTier.EPIC,      "All stamina drain reduced by 38%.")
                .tierDesc(PerkTier.LEGENDARY, "All stamina drain reduced by 50%. Stamina regenerates 15% faster.")
        ...
        register(PerkDefinition.builder("lightfoot", "Lightfoot")
                ...
                .tierDesc(PerkTier.RARE,      "Sprint speed +13%, sprint stamina cost -25%.")
                .tierDesc(PerkTier.EPIC,      "Sprint speed +18%, sprint stamina cost -35%. Sprint starts instantly.")
        ...
        register(PerkDefinition.builder("steadfast", "Steadfast")
                ...
                .tierDesc(PerkTier.LEGENDARY, "Full knockback immunity.")
                .upgradeCost(PerkTier.UNCOMMON,  PerkUpgradeCost.builder(5).item(Items.IRON_INGOT, 8).build())
        ...
        register(PerkDefinition.builder("vermilion_soul", "Vermilion Soul")
                .description("If you die, revive once per in-game day with half HP.")
                ...
                .tierDesc(PerkTier.EPIC,      "Once per in-game day: on death, revive with 40% HP.")
                .tierDesc(PerkTier.LEGENDARY, "Once per in-game day: on death, revive with 50% HP and brief Resistance II.")
        ...
        register(PerkDefinition.builder("moonlit_fury", "Moonlit Fury")
                ...
                .tierDesc(PerkTier.EPIC,      "Each kill at night: +2% damage (stacks up to 12x, resets at dawn).")
                .tierDesc(PerkTier.LEGENDARY, "Each kill at night: +2.5% damage (stacks up to 15x, resets at dawn). Stacks glow visibly.")
        ...
        register(PerkDefinition.builder("unbreakable", "Unbreakable")
                ...
                .tierDesc(PerkTier.EPIC,      "Once per fight: survive a fatal blow with 1 HP. 6 minute cooldown.")
                .tierDesc(PerkTier.LEGENDARY, "Once per fight: survive a fatal blow with 1 HP. 4 minute cooldown. Brief Resistance II on proc.")
