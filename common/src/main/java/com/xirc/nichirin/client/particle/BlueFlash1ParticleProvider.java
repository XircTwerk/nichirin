...
public class BlueFlash1ParticleProvider implements ParticleProvider<SimpleParticleType> {
    private final SpriteSet sprites;

    public BlueFlash1ParticleProvider(SpriteSet sprites) {
    ...
    public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z,
        ...
        return new Flash1Particle(level, x, y, z, xSpeed, ySpeed, zSpeed, sprites);
    }

    public static class Flash1Particle extends TextureSheetParticle {
        private final SpriteSet animatedSprites;

        protected Flash1Particle(ClientLevel level, double x, double y, double z,
