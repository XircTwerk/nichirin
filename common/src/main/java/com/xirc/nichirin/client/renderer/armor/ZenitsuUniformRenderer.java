...
public class ZenitsuUniformRenderer extends NichirinArmorRenderer<NichirinArmorItem> {
    public ZenitsuUniformRenderer() {
        super(new NichirinArmorModel<>("zenitsu_uniform"));
    }
    ...
    protected void applyBaseTransformations(HumanoidModel<?> baseModel) {
        ...
        // THEN: Apply all scaling and positioning (won't get overridden)
        if (this.currentEntity instanceof AbstractClientPlayer player) {
            ...
            if (renderer instanceof PlayerRenderer playerRenderer) {
                ...
                // Apply positioning based on player model type
                if (isSlim) {
                    if (baseLeftArm != null) {
