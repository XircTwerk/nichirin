...
public class BlueShockwaveParticleProvider implements ParticleProvider<SimpleParticleType> {
    private final SpriteSet sprites;

    public BlueShockwaveParticleProvider(SpriteSet sprites) {
    ...
    public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z,
        ...
        return new ShockwaveParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, sprites);
    }

    public static class ShockwaveParticle extends TextureSheetParticle {
